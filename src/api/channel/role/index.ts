...
export default class ChannelRole {
    ...
    async list(
        channelId: string
    ): Promise<RequestResponse<RawChannelRoleIndexResponse>> {
        return this.rest.get("/channel-role/index", {
            channel_id: channelId,
        });
    }

    private async __create<T extends "role_id" | "user_id">(
        channelId: string,
        type: T,
        value: string
    ): Promise<RequestResponse<RawChannelRoleResponse[T]>> {
    ...
    private async __update<T extends "role_id" | "user_id">(
        channelId: string,
        type: T,
        value: string,
        allow: number,
