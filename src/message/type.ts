...
class UserMessageEvent extends BaseMessageEvent {
    ...
    private isGroupMessage(
        object: WebSocket.NormalMessageEvent<NormalMessageType, GuildType>
    ): object is WebSocket.NormalMessageEvent<NormalMessageType, "GROUP"> {
    ...
    public async deleteReaction(emojiId: string, userId?: string) {
        return this.client.API.message.deleteReaction(
            this.messageId,
            emojiId,
            userId
        );
    ...
    constructor(
        rawEvent: WebSocket.NormalMessageEvent<NormalMessageType, GuildType>,
        client: Kasumi<any>
    ) {
        super(rawEvent, client);
...
export class PlainTextMessageEvent extends UserMessageEvent {
    ...
    constructor(
        rawEvent: WebSocket.NormalMessageEvent<
